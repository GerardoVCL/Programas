...
import {makeFetchingReducer, makeSetReducer, reduceReducers, makeCrudeReducer, mac, mat, asyncMac} from './utils'
...
const crudeReducer = makeCrudeReducer(['todos/add','todos/complete'])
